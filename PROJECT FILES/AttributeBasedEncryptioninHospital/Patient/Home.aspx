    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td>
                ...
                <asp:GridView ID="gdnews" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CssClass="table table-bordered" OnSelectedIndexChanged="gdnews_SelectedIndexChanged">
                    <Columns>
